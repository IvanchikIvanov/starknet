...
DELAY_BETWEEN_ACTIONS = [720, 4250]

# Initial delay between accounts
INITIAL_DELAY = [0, 50]

# Minimal amount for swap in percentage (only INTEGER). E.g., if you have 100$ on balance, the amount of each swap will be 10-20$
